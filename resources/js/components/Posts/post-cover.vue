...
<script setup>
    ...
    const fontColor = computed( () => props.post.cover.titleColor ? props.post.cover.titleColor : 'black');
    const backgroundColor = computed(() => props.post.cover.titleColor == 'black' ? 'white' : 'black');
</script>
<style scoped>
